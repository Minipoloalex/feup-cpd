...
def load_complete_line_df():
    return pd.concat(
        [
            pd.read_csv("line_data.csv"),
            pd.read_csv("line_data_compare_block.csv"),
        ],
        ignore_index=True,
    )
...
def plot_multicore_speedup():
    ...
    line_df_multicore_v1 = pd.read_csv("multicore_data_v1.csv")
    line_df_multicore_v2 = pd.read_csv("multicore_data_v2.csv")
    line_df_multicore_v1["speedup"] = line_df["time"] / line_df_multicore_v1["time"]
    line_df_multicore_v2["speedup"] = line_df["time"] / line_df_multicore_v2["time"]
    ...
    finish_plot("Line Matrix Multiplication: Multicore Speedup")
...
def plot_multicore_efficiency():
    ...
    line_df_multicore_v1 = pd.read_csv("multicore_data_v1.csv")
    line_df_multicore_v2 = pd.read_csv("multicore_data_v2.csv")
    line_df_multicore_v1["efficiency"] = line_df["time"] / (
        line_df_multicore_v1["num_threads"] * line_df_multicore_v1["time"]
    )
    line_df_multicore_v2["efficiency"] = line_df["time"] / (
        line_df_multicore_v2["num_threads"] * line_df_multicore_v2["time"]
    )
    ...
    finish_plot("Line Matrix Multiplication: Multicore Efficiency")
